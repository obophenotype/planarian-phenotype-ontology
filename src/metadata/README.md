 ...
 * [planp.yml](planp.yml)
     * Determines how your purl.obolibrary.org/obo/planp/ redirects will be handled
     ...
     * Paste in the contents of [planp.yml](planp.yml)
 ...
 * [planp.md](planp.md)
     ...
     * Paste in the contents of [planp.md](planp.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*

These notes are for the EDITORS of planp
...
Make sure you have an ID range in the [idranges file](planp-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [planp-edit.owl](planp-edit.owl)

** DO NOT EDIT planp.obo OR planp.owl in the top level directory **

[../../planp.owl](../../planp.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/srobb1/planarian-phenotype-ontology) for details.
 ...
 * [planp-idranges.owl](planp-idranges.owl)
...
This generates derived files such as planp.owl and planp.obo and places
 ...
 * https://github.com/srobb1/planarian-phenotype-ontology/releases
 * https://github.com/srobb1/planarian-phenotype-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived planp.owl (`data-version` in
planp.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/planp.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/planp/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/srobb1/planarian-phenotype-ontology.svg?branch=master)](https://travis-ci.org/srobb1/planarian-phenotype-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/srobb1](https://travis-ci.org/profile/srobb1)
 2. click the "Sync account" button
 3. Click the tick symbol next to planarian-phenotype-ontology
